      ...
      case 'initialize':
        return result(id, {
          ...
          instructions: [
            ...
            'listed. If get_apply_schema times out, call it once more: an idle hosted board can',
            'miss the first request and answer the retry in about a second. Do not treat one',
            'timeout as a dead endpoint.',
            '',
            'Listings declare an agent policy of welcome, disclose or human-only; when it',
